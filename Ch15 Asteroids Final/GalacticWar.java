...
public class GalacticWar extends Game {
    ...
    *****************************************************/
    ...
    void gameStartup() {
        ...
        shipImage[0].load("gun centered transparent.png");
        shipImage[1] = new ImageEntity(this);
        shipImage[1].load("gun centered thrust transparent.png");
        shipImage[2] = new ImageEntity(this);
        shipImage[2].load("gun centered shield transparent.PNG");
    ...
    void gameRefreshScreen() {
        ...
        if (gameState == GAME_MENU) {
            ...
            g2d.drawString("GUN POWERUPS DISABLED!", 240, 480);
            ...
            if (isAsteroid(spr2.spriteType())) {
                if (spr1.state() == STATE_NORMAL) {
                    if (keyShield) { //***
                        ...
                        startSmallExplosion(new Point2D(x, y));
...
//***
    ...
    private void spawnAsteroid(AnimatedSprite sprite) {
        ...
        double velx = calcAngleMoveX(ang) + rand.nextInt(3);
        double vely = calcAngleMoveY(ang) + rand.nextInt(3);
    ...
    public void createAsteroid() {
        ...
        //set velocity based on movement direction
        double ang = ast.moveAngle() - 90;
        double velx = calcAngleMoveX(ang) + i;
        double vely = calcAngleMoveY(ang) + i;
        ast.setVelocity(new Point2D(velx, vely));
    ...
    public void fireBullet() {
        ...
        AnimatedSprite[] bullets = new AnimatedSprite[1];

        switch(firepower) {
        case 1:
            bullets[0] = stockBullet();
            adjustDirection(bullets[0], 90);
